package me.lished.lavarun.game.sidebar
...
class LavarunSidebar(plugin: Gamesys, game: Game) : GameSidebar(plugin, game) {
    ...
    override fun getLines(player: GamePlayer): ArrayList<String> {
        ...
        list.add("<gray><st>----------------")
        list.add("<aqua>Kills: <white>${player.kills}")
        list.add("<gray><st>-----------------")
        ...
        list.add("<gray><st>-----------------")
        list.add("<aqua>IP: <white>skypanel.com")
        list.add("<gray><st>-----------------")
